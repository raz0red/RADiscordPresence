up
# RAD Presence — Website

Source for the [RAD Presence](https://github.com/raz0red/RADPresence) project website, hosted on GitHub Pages.
...
Push to this branch. GitHub Actions builds and publishes to `gh-pages` automatically.
