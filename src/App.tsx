      ...
      <main className="relative z-10 pt-32 pb-24 flex flex-col items-center">
        ...
        <section className="w-full max-w-5xl mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8 mb-32">
          ...
          <div className="w-full max-w-xl text-center lg:text-left flex flex-col items-center lg:items-start pt-8">
            <div className="flex flex-col sm:flex-row items-center gap-3 mb-6 animate-fade-up">
            ...
            <h1 className="font-display font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tighter leading-[1.05] bg-gradient-to-br from-white via-zinc-200 to-zinc-500 bg-clip-text text-transparent mb-6 animate-fade-up [animation-delay:100ms]">
            ...
            <p className="text-lg md:text-xl text-zinc-400 max-w-xl mx-auto lg:mx-0 mb-8 leading-relaxed animate-fade-up [animation-delay:200ms]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center w-full justify-center lg:justify-start animate-fade-up [animation-delay:300ms]">
              <a
                href={RELEASES_URL}
                target="_blank"
                rel="noreferrer"
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 text-sm text-zinc-400 font-medium w-full animate-fade-up [animation-delay:400ms]">
          ...
          <div className="w-full lg:w-auto flex justify-center relative shrink-0 pt-6 lg:pt-0 animate-fade-in [animation-delay:200ms]">
